...
if __name__ == "__main__":
    ...
    end_time = '2007/09/30'
    module = Data(station_id, start_time, end_time, num_lane, os.path.join(destpath, "2007"))  
    
    start_time = '2008/04/01'
    end_time = '2008/09/30'
    module = Data(station_id, start_time, end_time, num_lane, os.path.join(destpath, "2008"))  
    
    start_time = '2009/04/01'
    end_time = '2009/09/30'
    module = Data(station_id, start_time, end_time, num_lane, os.path.join(destpath, "2009")) 
